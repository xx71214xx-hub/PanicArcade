...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // إصلاح ثغرة زر "العب مجاناً" ومنع ظهوره إذا كان رصيد المستخدم صفر عملات
  function updatePopupButtons() {
    ...
    if (currentCoins >= 5) {
      ...
      if (freeBtn) freeBtn.style.display = "none"; // إخفاء زر اللعب مجاناً لعدم وجود ميزة الإعلانات حالياً
